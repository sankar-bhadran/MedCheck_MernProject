...
import pic from "../../Assets/Screenshot 2023-09-26 122057.png";
import LapGifPIC from "../../Assets/blood-test.gif";
        ...
        >
          <Grid item lg={2} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
            ...
            >
              ...
              <Typography
                variant="h6"
                sx={{ paddingTop: "10px", textDecoration: "none" }}
                cursor="pointer"
                component={Link}
                to="/labcustomer"
              >
        ...
        >
          <Paper
            ...
            sx={{
              ...
              borderRadius: "10px",
              backgroundImage:
                "linear-gradient(90deg, rgba(239,245,254,1) 0%, rgba(230,240,255,1) 49%, rgba(220,232,255,1) 100%)",
            }}
          >
